...
module.exports = {
  sendEmail: async (to, replyTo, verificationUrl, _id) => {
    let otp = Math.floor(Math.random() * (999999 - 100000 + 1) + 100000);
    console.log(`---------------------------------> ${otp}`);
    const object = {
      iTeamId: _id,
      emailFromInvitation: to,
    ...
    const mailOptions = {
      ...
      to: `${to}`,
      subject: `inivationMail from ${replyTo}`,
      replyTo: `${to}`,
      html: `<!DOCTYPE html>
                <html lang="en">
                                ...
                                <table align="center" cellpadding="0" cellspacing="0" width="600" style=" border-collapse: collapse; border: 1px solid #ececec; background-color: #fff;">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            >
                                            <h1 align="center" style="color: #fff; font-size: 35px; font-weight: 500; margin: 0 0 1rem 0;">invitation from ${replyTo}</h1>
                                    ...
                                    <tr>
                                        <td style="padding: 3rem 2rem 2rem 2rem;">
                                          <h2 align="center" style="color: #585d6a; font-size: 30px; ">This is invitation link from ${replyTo} </h2>
